! function(c) {
	...
	e.prototype = {
		...
		fill: function() {
			...
			while(E.valueOf() < g) {
				...
				m.push('<td class="day' + p + '"><div class="date-value"><b class="inner">' + E.getUTCDate() + "</b></div></td>");
		...
		click: function(k) {
			...
			var l = c(k.target).closest("span, td, th, legend");
      		c(k.target).hasClass('btn-cancel') && this.hide();
      		c(k.target).hasClass('btn-close') && this.hide();
	     	if(c(k.target).hasClass('btn-submit')){
		     	var _pre_d = c(k.target).closest('.datetimepicker-days').find('.in-date').text();
		     	var _last_d = c(k.target).closest('.datetimepicker-days').find("select  option:selected").text();
		     	
		      	if (this.viewSelect >= 2) {
		      		console.log(this.element.val());
		          	this.element.val(_pre_d+' '+_last_d);
		          	this.hide();
		      		console.log(this.element.val());
		      		console.log(_pre_d+' '+_last_d);
		      	}
	     	};
			if(l.length == 1) {
				if(l.is(".disabled")) {
	...
	b.headTemplate + b.contTemplate + b.footTemplate + 
	'</table></div><div class="datetimepicker-days">' +
    '<div class="datetime-picker-header"><span class="label-title">设置日期和时间</span><span class="btn-close">x</span></div>' +
    '<ul class="datetime-picker-input clearfix"><li class="in-date"><span class="dt-input-date">'+ 
    b.currentDate() + 
    '</span></li><li class="in-time"><select class="dt-input-time"><option value="2016-08-11 00:00">00:00</option><option value="2016-08-11 00:15">00:15</option><option value="2016-08-11 00:30">00:30</option><option value="2016-08-11 00:45">00:45</option><option value="2016-08-11 01:00">01:00</option><option value="2016-08-11 01:15">01:15</option><option value="2016-08-11 01:30">01:30</option><option value="2016-08-11 01:45">01:45</option><option value="2016-08-11 02:00">02:00</option><option value="2016-08-11 02:15">02:15</option><option value="2016-08-11 02:30">02:30</option><option value="2016-08-11 02:45">02:45</option><option value="2016-08-11 03:00">03:00</option><option value="2016-08-11 03:15">03:15</option><option value="2016-08-11 03:30">03:30</option><option value="2016-08-11 03:45">03:45</option><option value="2016-08-11 04:00">04:00</option><option value="2016-08-11 04:15">04:15</option><option value="2016-08-11 04:30">04:30</option><option value="2016-08-11 04:45">04:45</option><option value="2016-08-11 05:00">05:00</option><option value="2016-08-11 05:15">05:15</option><option value="2016-08-11 05:30">05:30</option><option value="2016-08-11 05:45">05:45</option><option value="2016-08-11 06:00">06:00</option><option value="2016-08-11 06:15">06:15</option><option value="2016-08-11 06:30">06:30</option><option value="2016-08-11 06:45">06:45</option><option value="2016-08-11 07:00">07:00</option><option value="2016-08-11 07:15">07:15</option><option value="2016-08-11 07:30">07:30</option><option value="2016-08-11 07:45">07:45</option><option value="2016-08-11 08:00">08:00</option><option value="2016-08-11 08:15">08:15</option><option value="2016-08-11 08:30">08:30</option><option value="2016-08-11 08:45">08:45</option><option value="2016-08-11 09:00">09:00</option><option value="2016-08-11 09:15">09:15</option><option value="2016-08